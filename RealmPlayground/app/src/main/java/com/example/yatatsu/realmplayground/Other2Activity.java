...
import com.example.yatatsu.realmplayground.databinding.ActivityOther2Binding;
...
public class Other2Activity extends AppCompatActivity {
  ...
  @Override protected void onCreate(@Nullable Bundle savedInstanceState) {
    ...
    Timber.i("onCreate");
    ActivityOther2Binding binding = DataBindingUtil.setContentView(this, R.layout.activity_other2);
